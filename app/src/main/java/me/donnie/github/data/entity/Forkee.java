...
public class Forkee implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.priva ? (byte) 1 : (byte) 0);
    ...
    protected Forkee(Parcel in) {
        this.id = in.readLong();
        this.name = in.readString();
        this.full_name = in.readString();
        this.owner = in.readParcelable(User.class.getClassLoader());
        this.priva = in.readByte() != 0;
    ...
    public static final Parcelable.Creator<Forkee> CREATOR = new Parcelable.Creator<Forkee>() {
        @Override
        public Forkee createFromParcel(Parcel source) {
            return new Forkee(source);
        }

        @Override
        public Forkee[] newArray(int size) {
            return new Forkee[size];
        }
    };
}
